...
import { fetchFabrics, fetchVrfs, createSubnet, fetchProvisioningJobs } from '../lib/api';
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                ...
                <tbody className="divide-y divide-slate-50">
                  {loading ? (
                    <tr>
                      <td colSpan={7} className="p-6 text-center text-slate-500">Loading subnets...</td>
                    </tr>
                  ) : subnets.length === 0 ? (
                    <tr>
                      <td colSpan={7} className="p-6 text-center text-slate-500">No subnets found.</td>
                    </tr>
                  ) : (
                    subnets.map((sub, idx) => {
